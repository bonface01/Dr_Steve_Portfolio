...
export function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 px-4 py-4 sm:px-6">
      <nav className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-slate-200 bg-white/95 px-5 py-3 text-navy shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur-xl">
        <Link href="/" className="font-heading text-xl text-navy">
          Steve Muthusi
        </Link>
